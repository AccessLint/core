...
import { SECTIONING_SELECTOR, LANDMARK_SELECTOR, makeNoDuplicateLandmarkRule } from "./constants";
...
export const landmarkNoDuplicateBanner = makeNoDuplicateLandmarkRule({
  id: "accesslint-037",
...
export const landmarkNoDuplicateContentinfo = makeNoDuplicateLandmarkRule({
  id: "accesslint-038",
...
export const landmarkNoDuplicateMain = makeNoDuplicateLandmarkRule({
  id: "accesslint-039",
