...
describe("accesslint-020", () => {
  ...
  it("passes input with aria-label", () => {
    ...
    expect(accesslint020.run(doc)).toHaveLength(0);
  });
  ...
  it("reports textarea without label", () => {
    ...
    expect(accesslint020.run(doc)).toHaveLength(1);
  });
