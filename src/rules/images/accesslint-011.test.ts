...
import { accesslint011 } from "./accesslint-011";
...
describe("accesslint-011", () => {
  it("reports images missing alt attribute", () => {
    ...
    const violations = accesslint011.run(doc);
  ...
  it("passes images with alt attribute", () => {
    ...
    expect(accesslint011.run(doc)).toHaveLength(0);
  });
  ...
  it("reports multiple violations", () => {
    ...
    expect(accesslint011.run(doc)).toHaveLength(2);
  });
});
